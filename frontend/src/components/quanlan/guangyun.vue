  ...
  <div class="bg" style="background-color: #f9f5f2">
    ...
    <div class="ciyun">
      ...
      <el-input class="txt2" v-model="input" placeholder="请输入汉字"
        style="width: 170px;" @keyup.enter="updateInput" />
    ...
    <div class="image3">
      <img src="@/assets/quanlan/bottom1.svg" class="image" style="width: 100vw; height: 100vh" />
    </div>
    ...
    <div class="choose">
      ...
      <ul class="choose-content">
        <li v-for="item in yunbu" class="hover-item" @click="getWords(item)">{{ item }}</li>
      </ul>
    </div>
...
.hover-item:hover {
  background-color: rgba(232, 129, 73, 0.3);
  /* 设置悬浮时的背景颜色 */
}
